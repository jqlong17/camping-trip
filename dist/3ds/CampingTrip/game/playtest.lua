...
function Playtest.tick(dt)
  ...
  elseif s == 21 and t > 0.2 then
    ...
    nextStep()
  elseif s == 22 and t > 0.5 then Playtest.shot("05d_fan"); E.tryUseGear(); nextStep() -- skip fan
  ...
  elseif s == 27 and t > 0.25 then
    ...
    nextStep()
  elseif s == 28 and t > 0.55 then
    Playtest.shot("06_night_lamp")
    Playtest.log("night stars=" .. #E.nightFX.stars .. " meteors=" .. #E.nightFX.meteors)
    nextStep()
  elseif s == 29 and t > 0.25 then
    Time.setClock(4 * 60 + 10) -- 04:10 黎明可回家
    Playtest.log("dawn day=" .. Time.dayIndex() .. " time=" .. Time.label())
    E.canGoHome = true
    nextStep()
  elseif s == 30 and t > 0.25 then E.goHomecoming(); Playtest.log("-> " .. E.scene); nextStep()
  elseif s == 31 and t > 0.35 then Playtest.shot("07_home"); nextStep()
  elseif s == 32 and t > 0.25 then E.advanceHome(); Playtest.log("-> " .. E.scene); nextStep()
  elseif s == 33 and t > 0.35 then Playtest.shot("07b_diary"); nextStep()
  elseif s == 34 and t > 0.25 then
    ...
    Playtest.log("-> " .. E.scene)
    nextStep()
  elseif s == 35 and t > 0.35 then Playtest.shot("08_back_title"); nextStep()
  elseif s == 36 and t > 0.2 then
    E.menuIndex = 4 -- 装备图鉴
    E.confirmMenu()
    Playtest.log("-> " .. E.scene)
    nextStep()
  elseif s == 37 and t > 0.35 then Playtest.shot("09_codex"); nextStep()
  elseif s == 38 and t > 0.15 then E.moveCodex(1); nextStep()
  elseif s == 39 and t > 0.25 then
    Playtest.log("codex=" .. tostring(E.gear[E.codex.i] and E.gear[E.codex.i].id))
    nextStep()
  elseif s == 40 and t > 0.2 then
    E.goTitle()
    E.menuIndex = 5 -- 关于
    E.confirmMenu()
    Playtest.log("-> " .. E.scene)
    nextStep()
  elseif s == 41 and t > 0.35 then
